...
kb1.add(button1, button2, button3, button4)
...
async def set_age(message, state):
    ...
    crud_functions.add_user(username, email, int(age))

    await state.finish()
    await message.reply("Регистрация завершена! Ваш аккаунт создан.", reply_markup=kb1)
